...
public class AESUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		String encrypt = aesEncrypt(content, keybyte);
		System.out.println("加密后：" + encrypt);
		
		String decrypt = aesDecrypt(encrypt, keybyte);
	 ...
	 * @throws Exception
	 */
	public static byte[] aesEncryptByte(String content, byte[] encryptKey) throws Exception {
		KeyGenerator kgen = KeyGenerator.getInstance("AES");
	...
	/**
	 * AES加密为base 64 code 密钥(byte格式)
	 * @param content 待加密的内容
	 * @param encryptKey 加密密钥(byte格式)
	 * @return 加密后的base 64 code
	 * @throws Exception
	 */
	public static String aesEncrypt(String content, byte[] encryptKey) throws Exception {
		return base64Encode(aesEncryptByte(content, encryptKey));
	}
	...
	/**
	 * 将base 64 code AES解密，密钥(byte格式)
	 * @param encryptStr 待解密的base 64 code
	 * @param decryptKey 解密密钥(byte格式)
	 * @return 解密后的string
	 * @throws Exception
	 */
