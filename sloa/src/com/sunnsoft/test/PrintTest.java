...
public class PrintTest implements Printable {
	...
	public int print(Graphics gra, PageFormat pf, int pageIndex)
		...
		case 0:
			...
			// "file:WebRoot/img/buton.jpg");
			// g2.drawImage(src, (int) x, (int) y, c);
			// int img_Height = src.getHeight(c);
			// int img_width = src.getWidth(c);
			// System.out.println("img_Height="+img_Height+"img_width="+img_width);
			// ;
			g2.drawString(str, (float) 5, (float) 30);
			g2.drawString(str, (float) 5, (float) 60);
			g2.drawString(str, (float) 5, (float) 90);
			g2.drawString(str, (float) 5, (float) 120);
			// g2.drawLine((int) 20, (int) (y + 1 * heigth + img_Height + 10),
