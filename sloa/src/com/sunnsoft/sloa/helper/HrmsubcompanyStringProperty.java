...
public class HrmsubcompanyStringProperty extends HrmsubcompanyProperty<String>{
	
	public HrmsubcompanyStringProperty(String propertyName, HrmsubcompanyHelper helper) {
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper Like(String value){//专门针对string类型
