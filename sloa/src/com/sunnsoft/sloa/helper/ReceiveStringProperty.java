...
public class ReceiveStringProperty extends ReceiveProperty<String>{
	
	public ReceiveStringProperty(String propertyName, ReceiveHelper helper) {
	 ...
	 * @return
	 */
	public ReceiveHelper Like(String value){//专门针对string类型
