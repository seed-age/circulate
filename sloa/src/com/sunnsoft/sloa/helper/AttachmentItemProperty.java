...
public class AttachmentItemProperty<T> {
	 ...
	 * @param helper
	 */
	public AttachmentItemProperty(String propertyName, AttachmentItemHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * 升序
	 */
	public AttachmentItemHelper Asc(){
	 ...
	 * @return
	 */
	public AttachmentItemHelper Desc(){
	 ...
	 * @return
	 */
	public AttachmentItemHelper Eq(T value){
	 ...
	 * @return
	 */
	public AttachmentItemHelper Ne(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
		if(value == null){
	 ...
	 * @return
	 */
	public AttachmentItemHelper Gt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public AttachmentItemHelper Ge(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public AttachmentItemHelper Lt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public AttachmentItemHelper Le(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public AttachmentItemHelper In(T... values){
	 ...
	 * @return
	 */
	public AttachmentItemHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public AttachmentItemHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public AttachmentItemHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public AttachmentItemHelper IsNull(){
	 ...
	 * @return
	 */
	public AttachmentItemHelper IsNotNull(){
	 ...
	 * @return
	 */
	public AttachmentItemHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public AttachmentItemHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = AttachmentItem.class.getMethod(setMethodName, this.type);
