...
public class HrmsubcompanyListProperty{
	
	public HrmsubcompanyListProperty(String propertyName, HrmsubcompanyHelper helper) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper IsEmpty(){ 
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper IsNotEmpty(){ 
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper SizeEq(int size){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper SizeNe(int size){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper SizeGe(int size){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper SizeLe(int size){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper SizeGt(int size){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper SizeLt(int size){
