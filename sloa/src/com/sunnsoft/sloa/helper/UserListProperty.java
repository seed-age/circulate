...
public class UserListProperty{
	
	public UserListProperty(String propertyName, UserHelper helper) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public UserHelper SizeEq(int size){
	 ...
	 * @return
	 */
	public UserHelper SizeNe(int size){
	 ...
	 * @return
	 */
	public UserHelper SizeGe(int size){
	 ...
	 * @return
	 */
	public UserHelper SizeLe(int size){
	 ...
	 * @return
	 */
	public UserHelper SizeGt(int size){
	 ...
	 * @return
	 */
	public UserHelper SizeLt(int size){
