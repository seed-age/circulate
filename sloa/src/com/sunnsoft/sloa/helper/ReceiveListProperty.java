...
public class ReceiveListProperty{
	
	public ReceiveListProperty(String propertyName, ReceiveHelper helper) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public ReceiveHelper IsNotEmpty(){ 
	 ...
	 * @return
	 */
	public ReceiveHelper SizeEq(int size){
	 ...
	 * @return
	 */
	public ReceiveHelper SizeNe(int size){
	 ...
	 * @return
	 */
	public ReceiveHelper SizeGe(int size){
	 ...
	 * @return
	 */
	public ReceiveHelper SizeLe(int size){
	 ...
	 * @return
	 */
	public ReceiveHelper SizeGt(int size){
	 ...
	 * @return
	 */
	public ReceiveHelper SizeLt(int size){
