...
public class UserCollectionListProperty{
	
	public UserCollectionListProperty(String propertyName, UserCollectionHelper helper) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public UserCollectionHelper IsEmpty(){ 
	 ...
	 * @return
	 */
	public UserCollectionHelper IsNotEmpty(){ 
	 ...
	 * @return
	 */
	public UserCollectionHelper SizeEq(int size){
	 ...
	 * @return
	 */
	public UserCollectionHelper SizeNe(int size){
	 ...
	 * @return
	 */
	public UserCollectionHelper SizeGe(int size){
	 ...
	 * @return
	 */
	public UserCollectionHelper SizeLe(int size){
	 ...
	 * @return
	 */
	public UserCollectionHelper SizeGt(int size){
	 ...
	 * @return
	 */
	public UserCollectionHelper SizeLt(int size){
