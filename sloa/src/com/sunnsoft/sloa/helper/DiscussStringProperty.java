...
public class DiscussStringProperty extends DiscussProperty<String>{
	
	public DiscussStringProperty(String propertyName, DiscussHelper helper) {
	 ...
	 * @return
	 */
	public DiscussHelper Like(String value){//专门针对string类型
