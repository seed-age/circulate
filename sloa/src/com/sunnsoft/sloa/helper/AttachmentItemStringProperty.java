...
public class AttachmentItemStringProperty extends AttachmentItemProperty<String>{
	
	public AttachmentItemStringProperty(String propertyName, AttachmentItemHelper helper) {
	 ...
	 * @return
	 */
	public AttachmentItemHelper Like(String value){//专门针对string类型
