...
public class UpdateRecordXls {
	
	private UpdateRecordHelper helper;
	
	private Import importer ;
	private Export<UpdateRecord> exporter;
	
	public UpdateRecordXls(UpdateRecordHelper helper) {
		this.helper = helper;
	}
	...
	private void processWorkbook(Workbook workbook){
		...
		this.helper.scrollResult(new ScrollEach<UpdateRecord>(){
	 ...
	 * @
	 */
	public UpdateRecordXls setImporter(Import importer){
	 ...
	 * @return
	 */
	public UpdateRecordXls setExporter(Export<UpdateRecord> exporter){
