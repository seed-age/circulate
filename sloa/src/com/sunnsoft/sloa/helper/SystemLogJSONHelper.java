...
public class SystemLogJSONHelper {
	...
	public SystemLogJSONHelper(SystemLogHelper helper) {
		super();
		this.helper = helper;
	}
	...
	public String fastJsonSerializer(final Object object , boolean ignoreExcludeAndFilter){
		...
		if(!ignoreExcludeAndFilter){
			if(excludeAll){
				fastJsonHelper.excludeAll(SystemLog.class);
				fastJsonHelper.removeExcludes(includes);
			}else{
				fastJsonHelper.addExcludes(excludes);
				switch (excludeRelactionType) {
				case 1:
					fastJsonHelper.excludeParent(SystemLog.class);
					break;
				case 2:
					fastJsonHelper.excludeChildren(SystemLog.class);
					break;
				case 3:
					fastJsonHelper.excludeForeignObject(SystemLog.class);
					break;
				default:
					break;
				}
	...
	protected JSONObject jsonSerializer(final Object object){
		...
		if(excludeAll){
			jsonHelper.excludeAll(SystemLog.class);
			jsonHelper.removeExcludes(includes);
		}else{
			jsonHelper.addExcludes(excludes);
			switch (excludeRelactionType) {
			case 1:
				jsonHelper.excludeParent(SystemLog.class);
				break;
			case 2:
				jsonHelper.excludeChildren(SystemLog.class);
				break;
			case 3:
				jsonHelper.excludeForeignObject(SystemLog.class);
				break;
			default:
				break;
			}
	 ...
	 * @return
	 */
	public SystemLogJSONHelper setDateFormat(String format){
	 ...
	 * 以缩进的方式输出，便于调试
	 */
	public SystemLogJSONHelper prettyFormat(){
	 ...
	 * 返回上一层helper对象继续其他操作
	 */
	public SystemLogHelper returnHelper(){
		return helper;
	}
	 ...
	 * 打印调试信息。
	 */
	public SystemLogJSONHelper debug(){
		this.prettyFormat = true;
		this.debug = true;
		return this;
	}
	 ...
	 * @return
	 */
	public SystemLogJSONHelper setBooleanToString(){
	 ...
	 * @return
	 */
	public SystemLogJSONHelper disableNullValue(){
	 ...
	 * @return
	 */
	public SystemLogJSONHelper cutOneToMany(){
	 ...
	 * @return
	 */
	public SystemLogJSONHelper cutManyToOne(){
	 ...
	 * @return
	 */
	public SystemLogJSONHelper cutXtoX(){//默认
	 ...
	 * @return
	 */
	public SystemLogJSONHelper keepXtoX(){
	 ...
	 * @return
	 */
	public String listJson(final EachEntity2Map<SystemLog> eachEntity2Map){
		final List list = new ArrayList();
		this.helper.each(new Each<SystemLog>() {

			@Override
			public void each(SystemLog bean, List<SystemLog> beans) {
				try {
	...
	public String listPageJson(int page,final EachEntity2Map<SystemLog> eachEntity2Map){
		final List list = new ArrayList();
		PageList pageList = this.helper.eachInPage(page,new Each<SystemLog>() {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public String listPageScrollJson(int page,final EachEntity2Map<SystemLog> eachEntity2Map){
		final List list = new ArrayList();
		PageScroll pageScroll = this.helper.eachInPageScroll(page,new Each<SystemLog>() {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public String listPageJson(int page ,int pageSize ,final EachEntity2Map<SystemLog> eachEntity2Map){
		final List list = new ArrayList();
		PageList pageList = this.helper.eachInPage(page,pageSize,new Each<SystemLog>() {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public String listPageScrollJson(int page ,int pageSize ,final EachEntity2Map<SystemLog> eachEntity2Map){
		final List list = new ArrayList();
		PageScroll pageScroll = this.helper.eachInPageScroll(page,pageSize,new Each<SystemLog>() {
	 ...
	 * @return
	 */
	public String uniqueJson(EachEntity2Map<SystemLog> eachEntity2Map){
		SystemLog bean = this.helper.uniqueResult();
		Map map = null;
		try {
	 ...
	 */
	public JSONArray jsonEach(final EachJSON<SystemLog> eachJSON){
		if(enableNameFilter){
			throw new HelperException("使用replaceKeyFor方法后，就不能转换为JSONObject或JSONArray进行处理");
		}
		if(enableValueFilter){
	 ...
	 * @return
	 */
	public JSONObject jsonEachInPage(int page,EachJSON<SystemLog> eachJSON){
		if(enableNameFilter){
			throw new HelperException("使用replaceKeyFor方法后，就不能转换为JSONObject或JSONArray进行处理");
		}
		if(enableValueFilter){
	 ...
	 * @return
	 */
	public JSONObject jsonEachInPageScroll(int page,EachJSON<SystemLog> eachJSON){
		if(enableNameFilter){
			throw new HelperException("使用replaceKeyFor方法后，就不能转换为JSONObject或JSONArray进行处理");
		}
		if(enableValueFilter){
	 ...
	 * @return
	 */
	public JSONObject jsonEachInPage(int page,int pageSize,final EachJSON<SystemLog> eachJSON){
		if(enableNameFilter){
			throw new HelperException("使用replaceKeyFor方法后，就不能转换为JSONObject或JSONArray进行处理");
		}
		if(enableValueFilter){
		...
		final JSONArray jsonArray = new JSONArray();
		JSONObject result = innerHelper.toJSONObject(this.helper.eachInPage(page, pageSize,new Each<SystemLog>(){
	 ...
	 * @return
	 */
	public JSONObject jsonEachInPageScroll(int page,int pageSize,final EachJSON<SystemLog> eachJSON){
		if(enableNameFilter){
			throw new HelperException("使用replaceKeyFor方法后，就不能转换为JSONObject或JSONArray进行处理");
		}
		if(enableValueFilter){
		...
		innerHelper.addExclude("list");
		final JSONArray jsonArray = new JSONArray();
		JSONObject result = innerHelper.toJSONObject(this.helper.eachInPageScroll(page, pageSize,new Each<SystemLog>(){
	 ...
	 * @return
	 */
	public SystemLogJSONHelper includeLogId(){
	 ...
	 * @return
	 */
	public SystemLogJSONHelper excludeLogId(){
	 ...
	 * @return
	 */
	public SystemLogJSONHelper includeOperator(){
		this.excludeAll = true;
	 ...
	 * @return
	 */
	public SystemLogJSONHelper excludeOperator(){
		this.excludeAll = false;
	 ...
	 * @return
	 */
	public SystemLogJSONHelper includeLogTime(){
		this.excludeAll = true;
	 ...
	 * @return
	 */
	public SystemLogJSONHelper excludeLogTime(){
		this.excludeAll = false;
	 ...
	 * @return
	 */
	public SystemLogJSONHelper includeAction(){
		this.excludeAll = true;
	 ...
	 * @return
	 */
	public SystemLogJSONHelper excludeAction(){
		this.excludeAll = false;
	 ...
	 * @return
	 */
	public SystemLogJSONHelper includeIp(){
		this.excludeAll = true;
	 ...
	 * @return
	 */
	public SystemLogJSONHelper excludeIp(){
		this.excludeAll = false;
	 ...
	 * @return
	 */
	public SystemLogJSONHelper includeIdentityInfo(){
		this.excludeAll = true;
	 ...
	 * @return
	 */
	public SystemLogJSONHelper excludeIdentityInfo(){
		this.excludeAll = false;
	 ...
	 * @return
	 */
	public SystemLogJSONHelper replaceKeyForLogId(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("logId", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, SystemLog.class, "logId", keyName);
		return this;
	}
	 ...
	 * @return
	 */
	public SystemLogJSONHelper replaceKeyForOperator(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("operator", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, SystemLog.class, "operator", keyName);
		return this;
	}
	 ...
	 * @return
	 */
	public SystemLogJSONHelper replaceKeyForLogTime(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("logTime", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, SystemLog.class, "logTime", keyName);
		return this;
	}
	 ...
	 * @return
	 */
	public SystemLogJSONHelper replaceKeyForAction(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("action", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, SystemLog.class, "action", keyName);
		return this;
	}
	 ...
	 * @return
	 */
	public SystemLogJSONHelper replaceKeyForIp(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("ip", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, SystemLog.class, "ip", keyName);
		return this;
	}
	 ...
	 * @return
	 */
	public SystemLogJSONHelper replaceKeyForIdentityInfo(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("identityInfo", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, SystemLog.class, "identityInfo", keyName);
		return this;
	}
	...
	public SystemLogJSONHelper filterLogId(FilterValue<Long> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, SystemLog.class, Long.class, filterValue, "logId");
		return this;
	}
	...
	public SystemLogJSONHelper filterOperator(FilterValue<String> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, SystemLog.class, String.class, filterValue, "operator");
		return this;
	}
	...
	public SystemLogJSONHelper filterLogTime(FilterValue<Date> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, SystemLog.class, Date.class, filterValue, "logTime");
		return this;
	}
	...
	public SystemLogJSONHelper filterAction(FilterValue<String> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, SystemLog.class, String.class, filterValue, "action");
		return this;
	}
	...
	public SystemLogJSONHelper filterIp(FilterValue<String> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, SystemLog.class, String.class, filterValue, "ip");
		return this;
	}
	...
	public SystemLogJSONHelper filterIdentityInfo(FilterValue<String> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, SystemLog.class, String.class, filterValue, "identityInfo");
		return this;
	}
