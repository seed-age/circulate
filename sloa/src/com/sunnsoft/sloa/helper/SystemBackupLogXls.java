...
public class SystemBackupLogXls {
	
	private SystemBackupLogHelper helper;
	
	private Import importer ;
	private Export<SystemBackupLog> exporter;
	
	public SystemBackupLogXls(SystemBackupLogHelper helper) {
		this.helper = helper;
	}
	...
	private void processWorkbook(Workbook workbook){
		...
		this.helper.scrollResult(new ScrollEach<SystemBackupLog>(){
	 ...
	 * @
	 */
	public SystemBackupLogXls setImporter(Import importer){
	 ...
	 * @return
	 */
	public SystemBackupLogXls setExporter(Export<SystemBackupLog> exporter){
