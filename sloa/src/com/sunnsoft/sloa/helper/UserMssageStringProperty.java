...
public class UserMssageStringProperty extends UserMssageProperty<String>{
	
	public UserMssageStringProperty(String propertyName, UserMssageHelper helper) {
	 ...
	 * @return
	 */
	public UserMssageHelper Like(String value){//专门针对string类型
