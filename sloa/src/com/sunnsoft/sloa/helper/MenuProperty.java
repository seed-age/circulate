...
public class MenuProperty<T> {
	 ...
	 * @param helper
	 */
	public MenuProperty(String propertyName, MenuHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public MenuHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public MenuHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public MenuHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public MenuHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public MenuHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = Menu.class.getMethod(setMethodName, this.type);
