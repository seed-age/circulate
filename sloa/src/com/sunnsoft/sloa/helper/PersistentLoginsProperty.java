...
public class PersistentLoginsProperty<T> {
	 ...
	 * @param helper
	 */
	public PersistentLoginsProperty(String propertyName, PersistentLoginsHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * 升序
	 */
	public PersistentLoginsHelper Asc(){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper Desc(){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper Eq(T value){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper Ne(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
		if(value == null){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper Gt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public PersistentLoginsHelper Ge(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public PersistentLoginsHelper Lt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public PersistentLoginsHelper Le(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public PersistentLoginsHelper In(T... values){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public PersistentLoginsHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public PersistentLoginsHelper IsNull(){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper IsNotNull(){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = PersistentLogins.class.getMethod(setMethodName, this.type);
