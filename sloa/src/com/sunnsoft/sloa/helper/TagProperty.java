...
public class TagProperty<T> {
	 ...
	 * @param helper
	 */
	public TagProperty(String propertyName, TagHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public TagHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public TagHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public TagHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public TagHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public TagHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = Tag.class.getMethod(setMethodName, this.type);
