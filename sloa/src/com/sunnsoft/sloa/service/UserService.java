...
public interface UserService extends IService<User,java.lang.Long> {
	/**
	 * 获得所有数据记录
	 ...
	 * @return 结果"卷轴分页"对象 {@link PageScroll}
	 */
	public PageScroll<User> findByDetachedCriteriaByDefaultPageScroll(DetachedCriteria dc,int limit);
	/**
