...
(function(){
	...
	var roleSelFunction = function(view,record) {
		var n = record.raw;
		menuStore.getProxy().setExtraParam("roleId",n.id);
		menuStore.reload({node:menuStore.getRootNode()});
		//menuStore.getRootNode().expand(true);
		userStore.getProxy().setExtraParam("roleId",n.id);
		userStore.load();
