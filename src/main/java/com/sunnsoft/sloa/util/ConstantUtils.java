...
public class ConstantUtils {
    ...
    // 传阅状态
    public static final Integer MAIL_STATUS = 0;     // 无状态
    public static final Integer MAIL_WAIT_STATUS = 1;     // 待发传阅
    public static final Integer MAIL_DELETE_STATUS = 7;     // 已删除

    // 传阅流程状态
    public static final Integer MAIL_HALFWAY_STATUS = 1;     // 传阅中
    public static final Integer RECEIVE_AWAIT_STATUS = 2;     // 待办传阅
    public static final Integer MAIL_COMPLETE_STATUS = 3;     // 传阅已完成

    // 已收传阅状态
    public static final Integer RECEIVE_WAIT_STATUS = 4;     // 草稿传阅
    public static final Integer RECEIVE_UNREAD_STATUS = 5;     // 未读传阅
    public static final Integer RECEIVE_READ_STATUS = 6;     // 已读传阅
    public static final Integer RECEIVE_NOTOPEN_STATUS = 0;     // 未开封
    public static final Integer RECEIVE_OPEN_STATUS = 1;     // 已开封
