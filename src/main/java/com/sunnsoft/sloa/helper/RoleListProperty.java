...
public class RoleListProperty{
	...
	public RoleListProperty(String propertyName, RoleHelper helper) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public RoleHelper SizeEq(int size){
	 ...
	 * @return
	 */
	public RoleHelper SizeNe(int size){
	 ...
	 * @return
	 */
	public RoleHelper SizeGe(int size){
	 ...
	 * @return
	 */
	public RoleHelper SizeLe(int size){
	 ...
	 * @return
	 */
	public RoleHelper SizeGt(int size){
	 ...
	 * @return
	 */
	public RoleHelper SizeLt(int size){
