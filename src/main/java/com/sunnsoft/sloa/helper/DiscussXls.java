...
public class DiscussXls {
	
	private DiscussHelper helper;
	
	private Import importer ;
	private Export<Discuss> exporter;
	
	public DiscussXls(DiscussHelper helper) {
		this.helper = helper;
	}
	...
	private void processWorkbook(Workbook workbook){
		...
		this.helper.scrollResult(new ScrollEach<Discuss>(){
	 ...
	 * @
	 */
	public DiscussXls setImporter(Import importer){
	 ...
	 * @return
	 */
	public DiscussXls setExporter(Export<Discuss> exporter){
