...
public class SystemBackupLogListProperty{
	
	public SystemBackupLogListProperty(String propertyName, SystemBackupLogHelper helper) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public SystemBackupLogHelper IsEmpty(){ 
	 ...
	 * @return
	 */
	public SystemBackupLogHelper IsNotEmpty(){ 
	 ...
	 * @return
	 */
	public SystemBackupLogHelper SizeEq(int size){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper SizeNe(int size){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper SizeGe(int size){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper SizeLe(int size){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper SizeGt(int size){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper SizeLt(int size){
