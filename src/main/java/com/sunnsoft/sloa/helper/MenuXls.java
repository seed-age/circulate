...
public class MenuXls {
	
	private MenuHelper helper;
	
	private Import importer ;
	private Export<Menu> exporter;
	
	public MenuXls(MenuHelper helper) {
		this.helper = helper;
	}
	...
	private void processWorkbook(Workbook workbook){
		...
		this.helper.scrollResult(new ScrollEach<Menu>(){
	 ...
	 * @
	 */
	public MenuXls setImporter(Import importer){
	 ...
	 * @return
	 */
	public MenuXls setExporter(Export<Menu> exporter){
