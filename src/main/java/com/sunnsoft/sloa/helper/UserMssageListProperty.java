...
public class UserMssageListProperty{
	
	public UserMssageListProperty(String propertyName, UserMssageHelper helper) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public UserMssageHelper IsEmpty(){ 
	 ...
	 * @return
	 */
	public UserMssageHelper IsNotEmpty(){ 
	 ...
	 * @return
	 */
	public UserMssageHelper SizeEq(int size){
	 ...
	 * @return
	 */
	public UserMssageHelper SizeNe(int size){
	 ...
	 * @return
	 */
	public UserMssageHelper SizeGe(int size){
	 ...
	 * @return
	 */
	public UserMssageHelper SizeLe(int size){
	 ...
	 * @return
	 */
	public UserMssageHelper SizeGt(int size){
	 ...
	 * @return
	 */
	public UserMssageHelper SizeLt(int size){
