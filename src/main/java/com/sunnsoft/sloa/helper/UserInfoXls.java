...
public class UserInfoXls {
	
	private UserInfoHelper helper;
	
	private Import importer ;
	private Export<UserInfo> exporter;
	
	public UserInfoXls(UserInfoHelper helper) {
		this.helper = helper;
	}
	...
	private void processWorkbook(Workbook workbook){
		...
		this.helper.scrollResult(new ScrollEach<UserInfo>(){
	 ...
	 * @
	 */
	public UserInfoXls setImporter(Import importer){
	 ...
	 * @return
	 */
	public UserInfoXls setExporter(Export<UserInfo> exporter){
