...
public class UserCollectionXls {
	
	private UserCollectionHelper helper;
	
	private Import importer ;
	private Export<UserCollection> exporter;
	
	public UserCollectionXls(UserCollectionHelper helper) {
		this.helper = helper;
	}
	...
	private void processWorkbook(Workbook workbook){
		...
		this.helper.scrollResult(new ScrollEach<UserCollection>(){
	 ...
	 * @
	 */
	public UserCollectionXls setImporter(Import importer){
	 ...
	 * @return
	 */
	public UserCollectionXls setExporter(Export<UserCollection> exporter){
