...
public class PersistentLoginsListProperty{
	
	public PersistentLoginsListProperty(String propertyName, PersistentLoginsHelper helper) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public PersistentLoginsHelper IsEmpty(){ 
	 ...
	 * @return
	 */
	public PersistentLoginsHelper IsNotEmpty(){ 
	 ...
	 * @return
	 */
	public PersistentLoginsHelper SizeEq(int size){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper SizeNe(int size){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper SizeGe(int size){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper SizeLe(int size){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper SizeGt(int size){
	 ...
	 * @return
	 */
	public PersistentLoginsHelper SizeLt(int size){
