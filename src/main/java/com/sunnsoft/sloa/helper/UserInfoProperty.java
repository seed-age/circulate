...
public class UserInfoProperty<T> {
	 ...
	 * @param helper
	 */
	public UserInfoProperty(String propertyName, UserInfoHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public UserInfoHelper Eq(T value){
	 ...
	 * @return
	 */
	public UserInfoHelper Ne(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
		if(value == null){
	 ...
	 * @return
	 */
	public UserInfoHelper Gt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserInfoHelper Ge(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserInfoHelper Lt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserInfoHelper Le(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserInfoHelper In(T... values){
	 ...
	 * @return
	 */
	public UserInfoHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public UserInfoHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserInfoHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public UserInfoHelper IsNotNull(){
	 ...
	 * @return
	 */
	public UserInfoHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public UserInfoHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = UserInfo.class.getMethod(setMethodName, this.type);
