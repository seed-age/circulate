...
public class UserInfoStringProperty extends UserInfoProperty<String>{
	
	public UserInfoStringProperty(String propertyName, UserInfoHelper helper) {
	 ...
	 * @return
	 */
	public UserInfoHelper Like(String value){//专门针对string类型
