...
public class UserCollectionProperty<T> {
	 ...
	 * @param helper
	 */
	public UserCollectionProperty(String propertyName, UserCollectionHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * 升序
	 */
	public UserCollectionHelper Asc(){
	 ...
	 * @return
	 */
	public UserCollectionHelper Desc(){
	 ...
	 * @return
	 */
	public UserCollectionHelper Eq(T value){
	 ...
	 * @return
	 */
	public UserCollectionHelper Ne(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
		if(value == null){
	 ...
	 * @return
	 */
	public UserCollectionHelper Gt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserCollectionHelper Ge(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserCollectionHelper Lt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserCollectionHelper Le(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserCollectionHelper In(T... values){
	 ...
	 * @return
	 */
	public UserCollectionHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public UserCollectionHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserCollectionHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public UserCollectionHelper IsNull(){
	 ...
	 * @return
	 */
	public UserCollectionHelper IsNotNull(){
	 ...
	 * @return
	 */
	public UserCollectionHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public UserCollectionHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = UserCollection.class.getMethod(setMethodName, this.type);
