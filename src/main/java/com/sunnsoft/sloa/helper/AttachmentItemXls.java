...
public class AttachmentItemXls {
	
	private AttachmentItemHelper helper;
	
	private Import importer ;
	private Export<AttachmentItem> exporter;
	
	public AttachmentItemXls(AttachmentItemHelper helper) {
		this.helper = helper;
	}
	...
	private void processWorkbook(Workbook workbook){
		...
		this.helper.scrollResult(new ScrollEach<AttachmentItem>(){
	 ...
	 * @
	 */
	public AttachmentItemXls setImporter(Import importer){
	 ...
	 * @return
	 */
	public AttachmentItemXls setExporter(Export<AttachmentItem> exporter){
