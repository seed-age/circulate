...
public class UserCollectionJSONHelper {
	...
	public UserCollectionJSONHelper(UserCollectionHelper helper) {
		super();
		this.helper = helper;
	}
	...
	public String fastJsonSerializer(final Object object , boolean ignoreExcludeAndFilter){
		...
		if(!ignoreExcludeAndFilter){
			if(excludeAll){
				fastJsonHelper.excludeAll(UserCollection.class);
				fastJsonHelper.removeExcludes(includes);
			}else{
				fastJsonHelper.addExcludes(excludes);
				switch (excludeRelactionType) {
				case 1:
					fastJsonHelper.excludeParent(UserCollection.class);
					break;
				case 2:
					fastJsonHelper.excludeChildren(UserCollection.class);
					break;
				case 3:
					fastJsonHelper.excludeForeignObject(UserCollection.class);
					break;
				default:
					break;
				}
	...
	protected JSONObject jsonSerializer(final Object object){
		...
		if(excludeAll){
			jsonHelper.excludeAll(UserCollection.class);
			jsonHelper.removeExcludes(includes);
		}else{
			jsonHelper.addExcludes(excludes);
			switch (excludeRelactionType) {
			case 1:
				jsonHelper.excludeParent(UserCollection.class);
				break;
			case 2:
				jsonHelper.excludeChildren(UserCollection.class);
				break;
			case 3:
				jsonHelper.excludeForeignObject(UserCollection.class);
				break;
			default:
				break;
			}
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper setDateFormat(String format){
	 ...
	 * 以缩进的方式输出，便于调试
	 */
	public UserCollectionJSONHelper prettyFormat(){
	 ...
	 * 返回上一层helper对象继续其他操作
	 */
	public UserCollectionHelper returnHelper(){
		return helper;
	}
	 ...
	 * 打印调试信息。
	 */
	public UserCollectionJSONHelper debug(){
		this.prettyFormat = true;
		this.debug = true;
		return this;
	}
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper setBooleanToString(){
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper disableNullValue(){
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper cutOneToMany(){
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper cutManyToOne(){
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper cutXtoX(){//默认
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper keepXtoX(){
	 ...
	 * @return
	 */
	public String listJson(final EachEntity2Map<UserCollection> eachEntity2Map){
		final List list = new ArrayList();
		this.helper.each(new Each<UserCollection>() {

			@Override
			public void each(UserCollection bean, List<UserCollection> beans) {
				try {
	...
	public String listPageJson(int page,final EachEntity2Map<UserCollection> eachEntity2Map){
		final List list = new ArrayList();
		PageList pageList = this.helper.eachInPage(page,new Each<UserCollection>() {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public String listPageScrollJson(int page,final EachEntity2Map<UserCollection> eachEntity2Map){
		final List list = new ArrayList();
		PageScroll pageScroll = this.helper.eachInPageScroll(page,new Each<UserCollection>() {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public String listPageJson(int page ,int pageSize ,final EachEntity2Map<UserCollection> eachEntity2Map){
		final List list = new ArrayList();
		PageList pageList = this.helper.eachInPage(page,pageSize,new Each<UserCollection>() {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public String listPageScrollJson(int page ,int pageSize ,final EachEntity2Map<UserCollection> eachEntity2Map){
		final List list = new ArrayList();
		PageScroll pageScroll = this.helper.eachInPageScroll(page,pageSize,new Each<UserCollection>() {
	 ...
	 * @return
	 */
	public String uniqueJson(EachEntity2Map<UserCollection> eachEntity2Map){
	 ...
	 */
	public JSONArray jsonEach(final EachJSON<UserCollection> eachJSON){
		if(enableNameFilter){
			throw new HelperException("使用replaceKeyFor方法后，就不能转换为JSONObject或JSONArray进行处理");
		}
		if(enableValueFilter){
	 ...
	 * @return
	 */
	public JSONObject jsonEachInPage(int page,EachJSON<UserCollection> eachJSON){
		if(enableNameFilter){
			throw new HelperException("使用replaceKeyFor方法后，就不能转换为JSONObject或JSONArray进行处理");
		}
		if(enableValueFilter){
	 ...
	 * @return
	 */
	public JSONObject jsonEachInPageScroll(int page,EachJSON<UserCollection> eachJSON){
		if(enableNameFilter){
			throw new HelperException("使用replaceKeyFor方法后，就不能转换为JSONObject或JSONArray进行处理");
		}
		if(enableValueFilter){
	 ...
	 * @return
	 */
	public JSONObject jsonEachInPage(int page,int pageSize,final EachJSON<UserCollection> eachJSON){
		if(enableNameFilter){
			throw new HelperException("使用replaceKeyFor方法后，就不能转换为JSONObject或JSONArray进行处理");
		}
		if(enableValueFilter){
		...
		final JSONArray jsonArray = new JSONArray();
		JSONObject result = innerHelper.toJSONObject(this.helper.eachInPage(page, pageSize,new Each<UserCollection>(){
	 ...
	 * @return
	 */
	public JSONObject jsonEachInPageScroll(int page,int pageSize,final EachJSON<UserCollection> eachJSON){
		if(enableNameFilter){
			throw new HelperException("使用replaceKeyFor方法后，就不能转换为JSONObject或JSONArray进行处理");
		}
		if(enableValueFilter){
		...
		innerHelper.addExclude("list");
		final JSONArray jsonArray = new JSONArray();
		JSONObject result = innerHelper.toJSONObject(this.helper.eachInPageScroll(page, pageSize,new Each<UserCollection>(){
	...
	/**
	 * 序列化json时候，包含 collectionId (收藏id)字段
	 * @return
	 */
	public UserCollectionJSONHelper includeCollectionId(){
		this.excludeAll = true;
		this.includes.add("collectionId");
		return this;
	}
	
	/**
	 * 序列化json时候，排除 collectionId (收藏id)字段
	 * @return
	 */
	public UserCollectionJSONHelper excludeCollectionId(){
		this.excludeAll = false;
		this.excludes.add("collectionId");
		return this;
	}
	/**
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper includeMail(){
		this.excludeAll = true;
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper excludeMail(){
		this.excludeAll = false;
		this.excludes.add("mail");
		return this;
	}
	/**
	 * 序列化json时候，包含 userId (收藏人id)字段
	 * @return
	 */
	public UserCollectionJSONHelper includeUserId(){
		this.excludeAll = true;
	...
	/**
	 * 序列化json时候，排除 userId (收藏人id)字段
	 * @return
	 */
	public UserCollectionJSONHelper excludeUserId(){
		this.excludeAll = false;
		this.excludes.add("userId");
		return this;
	}
	/**
	 * 序列化json时候，包含 workCode (收藏人工作编号)字段
	 * @return
	 */
	public UserCollectionJSONHelper includeWorkCode(){
		this.excludeAll = true;
	...
	/**
	 * 序列化json时候，排除 workCode (收藏人工作编号)字段
	 * @return
	 */
	public UserCollectionJSONHelper excludeWorkCode(){
		this.excludeAll = false;
		this.excludes.add("workCode");
		return this;
	}
	/**
	 * 序列化json时候，包含 lastName (收藏人的姓名)字段
	 * @return
	 */
	public UserCollectionJSONHelper includeLastName(){
		this.excludeAll = true;
	...
	/**
	 * 序列化json时候，排除 lastName (收藏人的姓名)字段
	 * @return
	 */
	public UserCollectionJSONHelper excludeLastName(){
		this.excludeAll = false;
		this.excludes.add("lastName");
		return this;
	}
	/**
	 * 序列化json时候，包含 collectionTime (收藏时间)字段
	 * @return
	 */
	public UserCollectionJSONHelper includeCollectionTime(){
		this.excludeAll = true;
		this.includes.add("collectionTime");
		return this;
	}
	
	/**
	 * 序列化json时候，排除 collectionTime (收藏时间)字段
	 * @return
	 */
	public UserCollectionJSONHelper excludeCollectionTime(){
		this.excludeAll = false;
		this.excludes.add("collectionTime");
		return this;
	}
	/**
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper includeDifferentiate(){
		this.excludeAll = true;
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper excludeDifferentiate(){
		this.excludeAll = false;
	...
	/**
	 * 序列化json时候， 替换 key collectionId 为 指定的keyName
	 * @param keyName
	 * @return
	 */
	public UserCollectionJSONHelper replaceKeyForCollectionId(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("collectionId", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, UserCollection.class, "collectionId", keyName);
		return this;
	}
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper replaceKeyForMail(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("mail", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, UserCollection.class, "mail", keyName);
		return this;
	}
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper replaceKeyForUserId(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("userId", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, UserCollection.class, "userId", keyName);
		return this;
	}
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper replaceKeyForWorkCode(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("workCode", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, UserCollection.class, "workCode", keyName);
		return this;
	}
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper replaceKeyForLastName(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("lastName", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, UserCollection.class, "lastName", keyName);
		return this;
	}
	
	/**
	 * 序列化json时候， 替换 key collectionTime 为 指定的keyName
	 * @param keyName
	 * @return
	 */
	public UserCollectionJSONHelper replaceKeyForCollectionTime(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("collectionTime", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, UserCollection.class, "collectionTime", keyName);
		return this;
	}
	 ...
	 * @return
	 */
	public UserCollectionJSONHelper replaceKeyForDifferentiate(String keyName){
		this.enableNameFilter = true;
		this.replaceMap.put("differentiate", keyName);
		FastJSONUtils.addNameFilterToJsonHelper(nameFilters, UserCollection.class, "differentiate", keyName);
		return this;
	}
	...
	/**
	 * 序列化json时候， 替换 collectionId 的值为其他值
	 * @param filterValue
	 * @return
	 */
	
	public UserCollectionJSONHelper filterCollectionId(FilterValue<Long> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, UserCollection.class, Long.class, filterValue, "collectionId");
		return this;
	}
	...
	public UserCollectionJSONHelper filterMail(FilterValue<Mail> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, UserCollection.class, Mail.class, filterValue, "mail");
		return this;
	}
	...
	public UserCollectionJSONHelper filterUserId(FilterValue<Long> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, UserCollection.class, Long.class, filterValue, "userId");
		return this;
	}
	...
	public UserCollectionJSONHelper filterWorkCode(FilterValue<String> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, UserCollection.class, String.class, filterValue, "workCode");
		return this;
	}
	...
	public UserCollectionJSONHelper filterLastName(FilterValue<String> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, UserCollection.class, String.class, filterValue, "lastName");
		return this;
	}
	
	/**
	 * 序列化json时候， 替换 collectionTime 的值为其他值
	 * @param filterValue
	 * @return
	 */
	
	public UserCollectionJSONHelper filterCollectionTime(FilterValue<Date> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, UserCollection.class, Date.class, filterValue, "collectionTime");
		return this;
	}
	...
	public UserCollectionJSONHelper filterDifferentiate(FilterValue<String> filterValue){
		this.enableValueFilter = true;
		filterValue.setFieldReplaceMap(this.replaceMap);
		FastJSONUtils.addValueFilterToJsonHelper(valueFilters, UserCollection.class, String.class, filterValue, "differentiate");
		return this;
	}
