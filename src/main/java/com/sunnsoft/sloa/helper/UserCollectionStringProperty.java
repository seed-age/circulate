...
public class UserCollectionStringProperty extends UserCollectionProperty<String>{
	
	public UserCollectionStringProperty(String propertyName, UserCollectionHelper helper) {
	 ...
	 * @return
	 */
	public UserCollectionHelper Like(String value){//专门针对string类型
