...
public class SystemLogStringProperty extends SystemLogProperty<String>{
	
	public SystemLogStringProperty(String propertyName, SystemLogHelper helper) {
	 ...
	 * @return
	 */
	public SystemLogHelper Like(String value){//专门针对string类型
