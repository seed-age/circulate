...
public class UserMssageProperty<T> {
	 ...
	 * @param helper
	 */
	public UserMssageProperty(String propertyName, UserMssageHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public UserMssageHelper Eq(T value){
	 ...
	 * @return
	 */
	public UserMssageHelper Ne(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
		if(value == null){
	 ...
	 * @return
	 */
	public UserMssageHelper Gt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserMssageHelper Ge(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserMssageHelper Lt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserMssageHelper Le(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserMssageHelper In(T... values){
	 ...
	 * @return
	 */
	public UserMssageHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public UserMssageHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public UserMssageHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public UserMssageHelper IsNull(){
	 ...
	 * @return
	 */
	public UserMssageHelper IsNotNull(){
	 ...
	 * @return
	 */
	public UserMssageHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public UserMssageHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = UserMssage.class.getMethod(setMethodName, this.type);
