...
public class ReceiveProperty<T> {
	 ...
	 * @param helper
	 */
	public ReceiveProperty(String propertyName, ReceiveHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public ReceiveHelper Eq(T value){
	 ...
	 * @return
	 */
	public ReceiveHelper Ne(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
		if(value == null){
	 ...
	 * @return
	 */
	public ReceiveHelper Gt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public ReceiveHelper Ge(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public ReceiveHelper Lt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public ReceiveHelper Le(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public ReceiveHelper In(T... values){
	 ...
	 * @return
	 */
	public ReceiveHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public ReceiveHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public ReceiveHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public ReceiveHelper IsNotNull(){
	 ...
	 * @return
	 */
	public ReceiveHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public ReceiveHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = Receive.class.getMethod(setMethodName, this.type);
