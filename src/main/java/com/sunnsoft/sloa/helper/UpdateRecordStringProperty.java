...
public class UpdateRecordStringProperty extends UpdateRecordProperty<String>{
	
	public UpdateRecordStringProperty(String propertyName, UpdateRecordHelper helper) {
	 ...
	 * @return
	 */
	public UpdateRecordHelper Like(String value){//专门针对string类型
