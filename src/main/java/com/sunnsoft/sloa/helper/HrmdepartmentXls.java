...
public class HrmdepartmentXls {
	
	private HrmdepartmentHelper helper;
	
	private Import importer ;
	private Export<Hrmdepartment> exporter;
	
	public HrmdepartmentXls(HrmdepartmentHelper helper) {
		this.helper = helper;
	}
	...
	private void processWorkbook(Workbook workbook){
		...
		this.helper.scrollResult(new ScrollEach<Hrmdepartment>(){
	 ...
	 * @
	 */
	public HrmdepartmentXls setImporter(Import importer){
	 ...
	 * @return
	 */
	public HrmdepartmentXls setExporter(Export<Hrmdepartment> exporter){
