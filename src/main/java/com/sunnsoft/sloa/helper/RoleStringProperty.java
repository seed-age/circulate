...
public class RoleStringProperty extends RoleProperty<String>{
	
	public RoleStringProperty(String propertyName, RoleHelper helper) {
	 ...
	 * @return
	 */
	public RoleHelper Like(String value){//专门针对string类型
