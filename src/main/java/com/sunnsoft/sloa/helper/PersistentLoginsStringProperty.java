...
public class PersistentLoginsStringProperty extends PersistentLoginsProperty<String>{
	
	public PersistentLoginsStringProperty(String propertyName, PersistentLoginsHelper helper) {
	 ...
	 * @return
	 */
	public PersistentLoginsHelper Like(String value){//专门针对string类型
