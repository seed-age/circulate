...
public class SystemBackupLogProperty<T> {
	 ...
	 * @param helper
	 */
	public SystemBackupLogProperty(String propertyName, SystemBackupLogHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * 升序
	 */
	public SystemBackupLogHelper Asc(){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper Desc(){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper Eq(T value){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper Ne(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
		if(value == null){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper Gt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public SystemBackupLogHelper Ge(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public SystemBackupLogHelper Lt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public SystemBackupLogHelper Le(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public SystemBackupLogHelper In(T... values){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public SystemBackupLogHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public SystemBackupLogHelper IsNull(){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper IsNotNull(){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public SystemBackupLogHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = SystemBackupLog.class.getMethod(setMethodName, this.type);
