...
public class MenuStringProperty extends MenuProperty<String>{
	
	public MenuStringProperty(String propertyName, MenuHelper helper) {
	 ...
	 * @return
	 */
	public MenuHelper Like(String value){//专门针对string类型
