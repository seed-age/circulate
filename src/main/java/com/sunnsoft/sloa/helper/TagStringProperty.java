...
public class TagStringProperty extends TagProperty<String>{
	
	public TagStringProperty(String propertyName, TagHelper helper) {
	 ...
	 * @return
	 */
	public TagHelper Like(String value){//专门针对string类型
