...
public class SystemLogBean {
	 ...
	 * 插入队列
	 */
	private List<SystemLog> insertBeans = new ArrayList<SystemLog>(10);
	/**
	 * 缓存的setter
	 */
	...
	static {
		Method[] ms = SystemLogBean.class.getDeclaredMethods();
	 ...
	 * @throws Exception
	 */
	private SystemLogBean copyValue(Object source,int mode) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @return
	 */
	public SystemLogBean copyValueForm(Object source){
		try {
	 ...
	 * @return
	 */
	public SystemLogBean copyNotNullValueForm(Object source){
		try {
	 ...
	 * @return
	 */
	public SystemLogBean copyNotEmptyValueForm(Object source){
		try {
	...
	public SystemLogBean(SystemLogHelper helper){
		this.helper = helper;
	}
	...
	*/
	...
	public SystemLogBean setLogId(Long logId){
	...
	*/
	...
	public SystemLogBean setLogIdIfNotNull(Long logId){
	    if(logId == null){
	    	return this;
	    }
	...
	*/
	...
	public SystemLogBean setLogIdWithDefaultValueWhenNull(Long logId,Long defaultValue){
		Long temp = logId;
	    if(logId == null){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public SystemLogBean setOperator(String operator){
	...
	*/
	...
	public SystemLogBean setOperatorIfNotNull(String operator){
	    if(operator == null){
	    	return this;
	    }
	...
	*/
	...
	public SystemLogBean setOperatorWithDefaultValueWhenNull(String operator,String defaultValue){
	...
	*/
	...
	public SystemLogBean setOperatorIfNotNullAndNotEmpty(String operator){
	...
	*/
	...
	public SystemLogBean setOperatorWithDefaultValueWhenNullOrEmpty(String operator,String defaultValue){
		String temp = operator;
		if(StringUtils.isEmpty(operator)){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public SystemLogBean setLogTime(Date logTime){
	...
	*/
	...
	public SystemLogBean setLogTimeIfNotNull(Date logTime){
	    if(logTime == null){
	    	return this;
	    }
	...
	*/
	...
	public SystemLogBean setLogTimeWithDefaultValueWhenNull(Date logTime,Date defaultValue){
		Date temp = logTime;
	    if(logTime == null){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public SystemLogBean setAction(String action){
	...
	*/
	...
	public SystemLogBean setActionIfNotNull(String action){
	    if(action == null){
	    	return this;
	    }
	...
	*/
	...
	public SystemLogBean setActionWithDefaultValueWhenNull(String action,String defaultValue){
		String temp = action;
	    if(action == null){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public SystemLogBean setActionIfNotNullAndNotEmpty(String action){
	...
	*/
	...
	public SystemLogBean setActionWithDefaultValueWhenNullOrEmpty(String action,String defaultValue){
		String temp = action;
		if(StringUtils.isEmpty(action)){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public SystemLogBean setIp(String ip){
	...
	*/
	...
	public SystemLogBean setIpIfNotNull(String ip){
	    if(ip == null){
	    	return this;
	    }
		return setIp(ip);
	...
	*/
	...
	public SystemLogBean setIpWithDefaultValueWhenNull(String ip,String defaultValue){
		String temp = ip;
	    if(ip == null){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public SystemLogBean setIpIfNotNullAndNotEmpty(String ip){
	...
	*/
	...
	public SystemLogBean setIpWithDefaultValueWhenNullOrEmpty(String ip,String defaultValue){
		String temp = ip;
		if(StringUtils.isEmpty(ip)){
	    	temp = defaultValue;
	    }
...
不和用户表直接外键关联。
	*/
	...
	public SystemLogBean setIdentityInfo(String identityInfo){
...
不和用户表直接外键关联。
	*/
	...
	public SystemLogBean setIdentityInfoIfNotNull(String identityInfo){
...
不和用户表直接外键关联。
	*/
	...
	public SystemLogBean setIdentityInfoWithDefaultValueWhenNull(String identityInfo,String defaultValue){
...
不和用户表直接外键关联。
	*/
	...
	public SystemLogBean setIdentityInfoIfNotNullAndNotEmpty(String identityInfo){
...
不和用户表直接外键关联。
	*/
	...
	public SystemLogBean setIdentityInfoWithDefaultValueWhenNullOrEmpty(String identityInfo,String defaultValue){
		String temp = identityInfo;
		if(StringUtils.isEmpty(identityInfo)){
	    	temp = defaultValue;
	    }
	 ...
	 * @return
	 */
	public List<SystemLog> update(){
		return this.helper.each(new Each<SystemLog>(){
	...
	public long batchUpdate(final int flushValve){
		return this.helper.scrollResult(new ScrollEach<SystemLog>(){
	 ...
	 * @return
	 */
	public List<SystemLog> getCreateBeans(){
	...
	public SystemLog insertUnique(){
		...
		SystemLog bean = insertBeans.get(0);
		this.helper.service.add(bean);
		return bean;
	}
	 ...
	 */
	public SystemLog ifFoundUpdateElseInsert(){
		SystemLog bean =  this.helper.uniqueResult();
		if(bean == null){
			bean = new SystemLog();
		}
	...
	public String ifFoundUpdateElseInsertThenConvertJson(){
		SystemLog bean = this.ifFoundUpdateElseInsert();
	 ...
	 * @throws InvocationTargetException
	 */
	public String ifFoundUpdateElseInsertThenConvertJson(EachEntity2Map<SystemLog> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		SystemLog bean = this.ifFoundUpdateElseInsert();
	 ...
	 * @throws InvocationTargetException
	 */
	public String insertJson(EachEntity2Map<SystemLog> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @throws InvocationTargetException
	 */
	public String insertUniqueJson(EachEntity2Map<SystemLog> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @throws InvocationTargetException
	 */
	public String updateJson(EachEntity2Map<SystemLog> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @throws InvocationTargetException
	 */
	public String updateUniqueJson(EachEntity2Map<SystemLog> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		return this._insertOrUpdateJson(true, true, eachEntity2Map);
	}
	
	private String _insertOrUpdateJson(boolean unique,boolean isUpdate,EachEntity2Map<SystemLog> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		if(!unique){
			List<SystemLog> list = isUpdate ? this.update() : this.insert();
			if(eachEntity2Map != null){
				List<Map> listMap = new ArrayList<Map>();
				for (SystemLog bean : list) {
					Map map = EntityUtils.convertEntityToMapWithoutForgeinRelation(bean);
					listMap.add(map);
			...
			SystemLog bean = isUpdate ? this.updateUnique() : this.insertUnique();
			if(eachEntity2Map != null){
				Map map = EntityUtils.convertEntityToMapWithoutForgeinRelation(bean);
				return this.helper.json().fastJsonSerializer(map, true);
			}else{
	...
	private void invokeSetters(SystemLog bean) {
		for (Iterator<String> iter = paramTypeMap.keySet().iterator(); iter.hasNext();) {
			...
			try {
				Method m = SystemLog.class.getMethod(setMethodName, paramTypeMap.get(propertyName));
				m.invoke(bean, value);
			} catch (Exception e) {
