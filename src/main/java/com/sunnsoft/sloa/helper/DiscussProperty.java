...
public class DiscussProperty<T> {
	 ...
	 * @param helper
	 */
	public DiscussProperty(String propertyName, DiscussHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public DiscussHelper Eq(T value){
	 ...
	 * @return
	 */
	public DiscussHelper Ne(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
		if(value == null){
	 ...
	 * @return
	 */
	public DiscussHelper Gt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public DiscussHelper Ge(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public DiscussHelper Lt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public DiscussHelper Le(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public DiscussHelper In(T... values){
	 ...
	 * @return
	 */
	public DiscussHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public DiscussHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public DiscussHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public DiscussHelper IsNotNull(){
	 ...
	 * @return
	 */
	public DiscussHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public DiscussHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = Discuss.class.getMethod(setMethodName, this.type);
