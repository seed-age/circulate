...
public class UpdateRecordListProperty{
	
	public UpdateRecordListProperty(String propertyName, UpdateRecordHelper helper) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public UpdateRecordHelper IsEmpty(){ 
	 ...
	 * @return
	 */
	public UpdateRecordHelper IsNotEmpty(){ 
	 ...
	 * @return
	 */
	public UpdateRecordHelper SizeEq(int size){
	 ...
	 * @return
	 */
	public UpdateRecordHelper SizeNe(int size){
	 ...
	 * @return
	 */
	public UpdateRecordHelper SizeGe(int size){
	 ...
	 * @return
	 */
	public UpdateRecordHelper SizeLe(int size){
	 ...
	 * @return
	 */
	public UpdateRecordHelper SizeGt(int size){
	 ...
	 * @return
	 */
	public UpdateRecordHelper SizeLt(int size){
