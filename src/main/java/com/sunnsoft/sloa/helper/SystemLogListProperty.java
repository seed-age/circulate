...
public class SystemLogListProperty{
	
	public SystemLogListProperty(String propertyName, SystemLogHelper helper) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public SystemLogHelper IsEmpty(){ 
	 ...
	 * @return
	 */
	public SystemLogHelper IsNotEmpty(){ 
	 ...
	 * @return
	 */
	public SystemLogHelper SizeEq(int size){
	 ...
	 * @return
	 */
	public SystemLogHelper SizeNe(int size){
	 ...
	 * @return
	 */
	public SystemLogHelper SizeGe(int size){
	 ...
	 * @return
	 */
	public SystemLogHelper SizeLe(int size){
	 ...
	 * @return
	 */
	public SystemLogHelper SizeGt(int size){
	 ...
	 * @return
	 */
	public SystemLogHelper SizeLt(int size){
