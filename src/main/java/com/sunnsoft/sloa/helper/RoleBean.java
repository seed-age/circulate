...
public class RoleBean {
	 ...
	 * 插入队列
	 */
	private List<Role> insertBeans = new ArrayList<Role>(10);
	/**
	 * 缓存的setter
	 */
	...
	static {
		Method[] ms = RoleBean.class.getDeclaredMethods();
	 ...
	 * @throws Exception
	 */
	private RoleBean copyValue(Object source,int mode) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @return
	 */
	public RoleBean copyValueForm(Object source){
		try {
	 ...
	 * @return
	 */
	public RoleBean copyNotNullValueForm(Object source){
		try {
	 ...
	 * @return
	 */
	public RoleBean copyNotEmptyValueForm(Object source){
		try {
	...
	public RoleBean(RoleHelper helper){
		this.helper = helper;
	}
	...
	*/
	...
	public RoleBean setRoleId(Long roleId){
		paramTypeMap.put("roleId", Long.class);
		paramValueMap.put("roleId", roleId);
	...
	*/
	...
	public RoleBean setRoleIdIfNotNull(Long roleId){
	    if(roleId == null){
	    	return this;
	    }
	...
	*/
	...
	public RoleBean setRoleIdWithDefaultValueWhenNull(Long roleId,Long defaultValue){
		Long temp = roleId;
	    if(roleId == null){
	    	temp = defaultValue;
	    }
		return setRoleId(temp);
	}
	
	

	public RoleBean setRole(Role role){
		paramTypeMap.put("role", Role.class);
		paramValueMap.put("role", role);
		if(this.current != null){
	...
	public RoleBean setRoleIfNotNull(Role role){
	    if(role == null){
	    	return this;
	    }
		return setRole(role);
	...
	public RoleBean setRoleWithDefaultValueWhenNull(Role role,Role defaultValue){
		Role temp = role;
	    if(role == null){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public RoleBean setRoleName(String roleName){
		paramTypeMap.put("roleName", String.class);
		paramValueMap.put("roleName", roleName);
		if(this.current != null){
	...
	*/
	...
	public RoleBean setRoleNameIfNotNull(String roleName){
	    if(roleName == null){
	    	return this;
	    }
	...
	*/
	...
	public RoleBean setRoleNameWithDefaultValueWhenNull(String roleName,String defaultValue){
		String temp = roleName;
	    if(roleName == null){
	    	temp = defaultValue;
	    }
		return setRoleName(temp);
	}
	...
	*/
	...
	public RoleBean setRoleNameIfNotNullAndNotEmpty(String roleName){
	...
	*/
	...
	public RoleBean setRoleNameWithDefaultValueWhenNullOrEmpty(String roleName,String defaultValue){
		String temp = roleName;
		if(StringUtils.isEmpty(roleName)){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public RoleBean setRoleDescription(String roleDescription){
		paramTypeMap.put("roleDescription", String.class);
		paramValueMap.put("roleDescription", roleDescription);
		if(this.current != null){
			current.setRoleDescription(roleDescription);
		}
		return this;
	}
	...
	*/
	...
	public RoleBean setRoleDescriptionIfNotNull(String roleDescription){
	    if(roleDescription == null){
	    	return this;
	    }
		return setRoleDescription(roleDescription);
	}
	/**
	*Name:角色描述
	*Comment:
	*/
	...
	public RoleBean setRoleDescriptionWithDefaultValueWhenNull(String roleDescription,String defaultValue){
		String temp = roleDescription;
	    if(roleDescription == null){
	    	temp = defaultValue;
	    }
		return setRoleDescription(temp);
	}
	...
	*/
	...
	public RoleBean setRoleDescriptionIfNotNullAndNotEmpty(String roleDescription){
	...
	*/
	...
	public RoleBean setRoleDescriptionWithDefaultValueWhenNullOrEmpty(String roleDescription,String defaultValue){
		String temp = roleDescription;
		if(StringUtils.isEmpty(roleDescription)){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public RoleBean setStatus(Boolean status){
		paramTypeMap.put("status", Boolean.class);
	...
	*/
	...
	public RoleBean setStatusIfNotNull(Boolean status){
	    if(status == null){
	    	return this;
	    }
	...
	*/
	...
	public RoleBean setStatusWithDefaultValueWhenNull(Boolean status,Boolean defaultValue){
		Boolean temp = status;
	    if(status == null){
	    	temp = defaultValue;
	    }
	 ...
	 * @return
	 */
	public List<Role> update(){
		return this.helper.each(new Each<Role>(){

			@Override
			public void each(Role bean, List<Role> list) {
				invokeSetters(bean);
			}
	...
	public long batchUpdate(final int flushValve){
		return this.helper.scrollResult(new ScrollEach<Role>(){
			...
			@Override
			public void each(Role bean,long index) {
				invokeSetters(bean);
			}
	 ...
	 * @return
	 */
	public List<Role> getCreateBeans(){
	 ...
	 */
	public Role ifFoundUpdateElseInsert(){
		Role bean =  this.helper.uniqueResult();
		if(bean == null){
			bean = new Role();
		}
	...
	public String ifFoundUpdateElseInsertThenConvertJson(){
		Role bean = this.ifFoundUpdateElseInsert();
	 ...
	 * @throws InvocationTargetException
	 */
	public String ifFoundUpdateElseInsertThenConvertJson(EachEntity2Map<Role> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		Role bean = this.ifFoundUpdateElseInsert();
	 ...
	 * @throws InvocationTargetException
	 */
	public String insertJson(EachEntity2Map<Role> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @throws InvocationTargetException
	 */
	public String insertUniqueJson(EachEntity2Map<Role> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @throws InvocationTargetException
	 */
	public String updateJson(EachEntity2Map<Role> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @throws InvocationTargetException
	 */
	public String updateUniqueJson(EachEntity2Map<Role> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		return this._insertOrUpdateJson(true, true, eachEntity2Map);
	}
	
	private String _insertOrUpdateJson(boolean unique,boolean isUpdate,EachEntity2Map<Role> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		if(!unique){
			List<Role> list = isUpdate ? this.update() : this.insert();
			...
			Role bean = isUpdate ? this.updateUnique() : this.insertUnique();
			if(eachEntity2Map != null){
				Map map = EntityUtils.convertEntityToMapWithoutForgeinRelation(bean);
				return this.helper.json().fastJsonSerializer(map, true);
			}else{
	...
	private void invokeSetters(Role bean) {
		for (Iterator<String> iter = paramTypeMap.keySet().iterator(); iter.hasNext();) {
			...
			try {
				Method m = Role.class.getMethod(setMethodName, paramTypeMap.get(propertyName));
				m.invoke(bean, value);
			} catch (Exception e) {
