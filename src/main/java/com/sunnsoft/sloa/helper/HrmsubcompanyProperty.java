...
public class HrmsubcompanyProperty<T> {
	 ...
	 * @param helper
	 */
	public HrmsubcompanyProperty(String propertyName, HrmsubcompanyHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * 升序
	 */
	public HrmsubcompanyHelper Asc(){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper Desc(){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper Eq(T value){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper Ne(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
		if(value == null){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper Gt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper Ge(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper Lt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper Le(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper In(T... values){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper IsNull(){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper IsNotNull(){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public HrmsubcompanyHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = Hrmsubcompany.class.getMethod(setMethodName, this.type);
