...
public class DictionaryListProperty{
	
	public DictionaryListProperty(String propertyName, DictionaryHelper helper) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public DictionaryHelper IsEmpty(){ 
	 ...
	 * @return
	 */
	public DictionaryHelper IsNotEmpty(){ 
	 ...
	 * @return
	 */
	public DictionaryHelper SizeEq(int size){
	 ...
	 * @return
	 */
	public DictionaryHelper SizeNe(int size){
	 ...
	 * @return
	 */
	public DictionaryHelper SizeGe(int size){
	 ...
	 * @return
	 */
	public DictionaryHelper SizeLe(int size){
	 ...
	 * @return
	 */
	public DictionaryHelper SizeGt(int size){
	 ...
	 * @return
	 */
	public DictionaryHelper SizeLt(int size){
