...
public class UserXls {
	...
	private Export<User> exporter;
	
	public UserXls(UserHelper helper) {
		this.helper = helper;
	}
	...
	private void processWorkbook(Workbook workbook){
		...
		this.helper.scrollResult(new ScrollEach<User>(){
	 ...
	 * @
	 */
	public UserXls setImporter(Import importer){
	 ...
	 * @return
	 */
	public UserXls setExporter(Export<User> exporter){
