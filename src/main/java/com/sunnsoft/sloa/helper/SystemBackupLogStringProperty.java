...
public class SystemBackupLogStringProperty extends SystemBackupLogProperty<String>{
	
	public SystemBackupLogStringProperty(String propertyName, SystemBackupLogHelper helper) {
	 ...
	 * @return
	 */
	public SystemBackupLogHelper Like(String value){//专门针对string类型
