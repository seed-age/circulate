...
public class PersistentLoginsBean {
	 ...
	 * 插入队列
	 */
	private List<PersistentLogins> insertBeans = new ArrayList<PersistentLogins>(10);
	/**
	 * 缓存的setter
	 */
	...
	static {
		Method[] ms = PersistentLoginsBean.class.getDeclaredMethods();
	 ...
	 * @throws Exception
	 */
	private PersistentLoginsBean copyValue(Object source,int mode) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @return
	 */
	public PersistentLoginsBean copyValueForm(Object source){
		try {
	 ...
	 * @return
	 */
	public PersistentLoginsBean copyNotNullValueForm(Object source){
		try {
	 ...
	 * @return
	 */
	public PersistentLoginsBean copyNotEmptyValueForm(Object source){
		try {
	...
	public PersistentLoginsBean(PersistentLoginsHelper helper){
		this.helper = helper;
	}
	...
	*/
	...
	public PersistentLoginsBean setSeries(String series){
		paramTypeMap.put("series", String.class);
		paramValueMap.put("series", series);
	...
	*/
	...
	public PersistentLoginsBean setSeriesIfNotNull(String series){
	    if(series == null){
	    	return this;
	    }
	...
	*/
	...
	public PersistentLoginsBean setSeriesWithDefaultValueWhenNull(String series,String defaultValue){
		String temp = series;
	    if(series == null){
	    	temp = defaultValue;
	    }
		return setSeries(temp);
	}
	...
	*/
	...
	public PersistentLoginsBean setSeriesIfNotNullAndNotEmpty(String series){
	...
	*/
	...
	public PersistentLoginsBean setSeriesWithDefaultValueWhenNullOrEmpty(String series,String defaultValue){
		String temp = series;
		if(StringUtils.isEmpty(series)){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public PersistentLoginsBean setUsername(String username){
	...
	*/
	...
	public PersistentLoginsBean setUsernameIfNotNull(String username){
	    if(username == null){
	    	return this;
	    }
	...
	*/
	...
	public PersistentLoginsBean setUsernameWithDefaultValueWhenNull(String username,String defaultValue){
	...
	*/
	...
	public PersistentLoginsBean setUsernameIfNotNullAndNotEmpty(String username){
	...
	*/
	...
	public PersistentLoginsBean setUsernameWithDefaultValueWhenNullOrEmpty(String username,String defaultValue){
		String temp = username;
		if(StringUtils.isEmpty(username)){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public PersistentLoginsBean setToken(String token){
		paramTypeMap.put("token", String.class);
		paramValueMap.put("token", token);
		if(this.current != null){
	...
	*/
	...
	public PersistentLoginsBean setTokenIfNotNull(String token){
	    if(token == null){
	    	return this;
	    }
	...
	*/
	...
	public PersistentLoginsBean setTokenWithDefaultValueWhenNull(String token,String defaultValue){
		String temp = token;
	    if(token == null){
	    	temp = defaultValue;
	    }
		return setToken(temp);
	}
	...
	*/
	...
	public PersistentLoginsBean setTokenIfNotNullAndNotEmpty(String token){
	...
	*/
	...
	public PersistentLoginsBean setTokenWithDefaultValueWhenNullOrEmpty(String token,String defaultValue){
		String temp = token;
		if(StringUtils.isEmpty(token)){
	    	temp = defaultValue;
	    }
	...
	*/
	...
	public PersistentLoginsBean setLastUsed(Date lastUsed){
		paramTypeMap.put("lastUsed", Date.class);
		paramValueMap.put("lastUsed", lastUsed);
		if(this.current != null){
			current.setLastUsed(lastUsed);
		}
		return this;
	}
	...
	*/
	...
	public PersistentLoginsBean setLastUsedIfNotNull(Date lastUsed){
	    if(lastUsed == null){
	    	return this;
	    }
		return setLastUsed(lastUsed);
	}
	/**
	*Name:last_used
	*Comment:
	*/
	...
	public PersistentLoginsBean setLastUsedWithDefaultValueWhenNull(Date lastUsed,Date defaultValue){
		Date temp = lastUsed;
	    if(lastUsed == null){
	    	temp = defaultValue;
	    }
		return setLastUsed(temp);
	}
	 ...
	 * @return
	 */
	public List<PersistentLogins> update(){
		return this.helper.each(new Each<PersistentLogins>(){

			@Override
			public void each(PersistentLogins bean, List<PersistentLogins> list) {
				invokeSetters(bean);
			}
	 ...
	 */
	public PersistentLogins updateUnique(){
	...
	public long batchUpdate(final int flushValve){
		return this.helper.scrollResult(new ScrollEach<PersistentLogins>(){
			...
			@Override
			public void each(PersistentLogins bean,long index) {
				invokeSetters(bean);
			}
	 ...
	 * @return
	 */
	public List<PersistentLogins> getCreateBeans(){
	 ...
	 * 新创建的Bean对象的引用
	 */
	private PersistentLogins current;
	 ...
	 * @return
	 */
	public PersistentLoginsBean create(){
		PersistentLogins bean = new PersistentLogins();
	 ...
	 * @return insert的bean
	 */
	public PersistentLogins insertUnique(){
		if(insertBeans.size() == 0){
			throw new HelperException("“插入队列”为空，请先调用create()方法new Bean再setter");
		}
		...
		PersistentLogins bean = insertBeans.get(0);
		this.helper.service.add(bean);
		return bean;
	}
	 ...
	 */
	public PersistentLogins ifFoundUpdateElseInsert(){
		PersistentLogins bean =  this.helper.uniqueResult();
		if(bean == null){
			bean = new PersistentLogins();
		}
		this.invokeSetters(bean);
	...
	public String ifFoundUpdateElseInsertThenConvertJson(){
		PersistentLogins bean = this.ifFoundUpdateElseInsert();
	 ...
	 * @throws InvocationTargetException
	 */
	public String ifFoundUpdateElseInsertThenConvertJson(EachEntity2Map<PersistentLogins> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		PersistentLogins bean = this.ifFoundUpdateElseInsert();
	 ...
	 * @throws InvocationTargetException
	 */
	public String insertJson(EachEntity2Map<PersistentLogins> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @throws InvocationTargetException
	 */
	public String insertUniqueJson(EachEntity2Map<PersistentLogins> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @throws InvocationTargetException
	 */
	public String updateJson(EachEntity2Map<PersistentLogins> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
	 ...
	 * @throws InvocationTargetException
	 */
	public String updateUniqueJson(EachEntity2Map<PersistentLogins> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		return this._insertOrUpdateJson(true, true, eachEntity2Map);
	}
	
	private String _insertOrUpdateJson(boolean unique,boolean isUpdate,EachEntity2Map<PersistentLogins> eachEntity2Map) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		if(!unique){
			List<PersistentLogins> list = isUpdate ? this.update() : this.insert();
			if(eachEntity2Map != null){
				List<Map> listMap = new ArrayList<Map>();
				for (PersistentLogins bean : list) {
					Map map = EntityUtils.convertEntityToMapWithoutForgeinRelation(bean);
					listMap.add(map);
			...
			PersistentLogins bean = isUpdate ? this.updateUnique() : this.insertUnique();
			if(eachEntity2Map != null){
				Map map = EntityUtils.convertEntityToMapWithoutForgeinRelation(bean);
				return this.helper.json().fastJsonSerializer(map, true);
			}else{
	...
	private void invokeSetters(PersistentLogins bean) {
		for (Iterator<String> iter = paramTypeMap.keySet().iterator(); iter.hasNext();) {
			...
			try {
				Method m = PersistentLogins.class.getMethod(setMethodName, paramTypeMap.get(propertyName));
				m.invoke(bean, value);
			} catch (Exception e) {
