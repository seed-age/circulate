...
public class DictionaryXls {
	
	private DictionaryHelper helper;
	
	private Import importer ;
	private Export<Dictionary> exporter;
	
	public DictionaryXls(DictionaryHelper helper) {
		this.helper = helper;
	}
	...
	private void processWorkbook(Workbook workbook){
		...
		this.helper.scrollResult(new ScrollEach<Dictionary>(){
	 ...
	 * @
	 */
	public DictionaryXls setImporter(Import importer){
	 ...
	 * @return
	 */
	public DictionaryXls setExporter(Export<Dictionary> exporter){
