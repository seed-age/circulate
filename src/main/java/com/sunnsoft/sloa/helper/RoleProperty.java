...
public class RoleProperty<T> {
	 ...
	 * @param helper
	 */
	public RoleProperty(String propertyName, RoleHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public RoleHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public RoleHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public RoleHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public RoleHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public RoleHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = Role.class.getMethod(setMethodName, this.type);
