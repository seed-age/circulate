...
public class DictionaryStringProperty extends DictionaryProperty<String>{
	
	public DictionaryStringProperty(String propertyName, DictionaryHelper helper) {
	 ...
	 * @return
	 */
	public DictionaryHelper Like(String value){//专门针对string类型
