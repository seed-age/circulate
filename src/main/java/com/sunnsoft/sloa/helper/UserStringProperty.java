...
public class UserStringProperty extends UserProperty<String>{
	
	public UserStringProperty(String propertyName, UserHelper helper) {
	 ...
	 * @return
	 */
	public UserHelper Like(String value){//专门针对string类型
