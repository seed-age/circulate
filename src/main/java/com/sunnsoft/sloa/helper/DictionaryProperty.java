...
public class DictionaryProperty<T> {
	 ...
	 * @param helper
	 */
	public DictionaryProperty(String propertyName, DictionaryHelper helper,Class<T> type) {
		super();
		this.helper = helper;
	 ...
	 * @return
	 */
	public DictionaryHelper Eq(T value){
	 ...
	 * @return
	 */
	public DictionaryHelper Ne(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
		if(value == null){
	 ...
	 * @return
	 */
	public DictionaryHelper Gt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public DictionaryHelper Ge(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public DictionaryHelper Lt(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public DictionaryHelper Le(T value){
		if(helper.ignoreEmpty && valueEmpty( value )){
			return helper;
		}
	 ...
	 * @return
	 */
	public DictionaryHelper In(T... values){
	 ...
	 * @return
	 */
	public DictionaryHelper In(Collection<T> values){
	 ...
	 * @return
	 */
	public DictionaryHelper NotIn(T... values){
		if(helper.ignoreEmpty && (values == null || values.length == 0 )){
			return helper;
		}
	 ...
	 * @return
	 */
	public DictionaryHelper NotIn(Collection<T> values){
		if(helper.ignoreEmpty && (values == null || values.isEmpty() )){
			return helper;
		}
		this.add(Restrictions.not(Restrictions.in(propertyName, values)));
	 ...
	 * @return
	 */
	public DictionaryHelper IsNull(){
	 ...
	 * @return
	 */
	public DictionaryHelper IsNotNull(){
	 ...
	 * @return
	 */
	public DictionaryHelper EqOrNull(T value){
		if(value == null){
	 ...
	 * @return
	 */
	public DictionaryHelper NeOrNull(T value){
		if(value == null){
			throw new HelperException("value不能为null");
		}
	...
	public void setValue(final T value){
		...
		try {
			final Method m = Dictionary.class.getMethod(setMethodName, this.type);
