...
public interface UserInfoService extends IService<UserInfo, Long> {
	/**
	 * 获得所有数据记录
	 ...
	 * @return vo 列表
 	 */
	public List<UserInfo> findByIdsIncludeNull(Long[] ids);
	/**
	 * 根据某个属性的值查找vo
	 * @param propName
	 * @param value
	 ...
	 * @return 结果"卷轴分页"对象 {@link PageScroll}
	 */
	public PageScroll<UserInfo> findByDetachedCriteriaByDefaultPageScroll(DetachedCriteria dc, int limit);
	/**
