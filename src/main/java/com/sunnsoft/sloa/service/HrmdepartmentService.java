...
public interface HrmdepartmentService extends IService<Hrmdepartment, Integer> {
	/**
	 * 获得所有数据记录
	 ...
	 * @return vo 列表
 	 */
	public List<Hrmdepartment> findByIds(Integer[] ids);
	/**
	 * 根据ID列表查找vo 列表，找不到的对象用null代替。
	 * @param ids
	 * @return vo 列表
 	 */
	public List<Hrmdepartment> findByIdsIncludeNull(Integer[] ids);
	/**
	 * 根据某个属性的值查找vo
	 * @param propName
	 * @param value
	 ...
	 * @return 结果"卷轴分页"对象 {@link PageScroll}
	 */
	public PageScroll<Hrmdepartment> findByDetachedCriteriaByDefaultPageScroll(DetachedCriteria dc, int limit);
	/**
