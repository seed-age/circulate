...
public interface DictionaryService extends IService<Dictionary, Long> {
	/**
	 * 获得所有数据记录
	 ...
	 * @return vo 列表
 	 */
	public List<Dictionary> findByIdsIncludeNull(Long[] ids);
	/**
	 * 根据某个属性的值查找vo
	 * @param propName
	 * @param value
	 ...
	 * @return 结果"卷轴分页"对象 {@link PageScroll}
	 */
	public PageScroll<Dictionary> findByDetachedCriteriaByDefaultPageScroll(DetachedCriteria dc, int limit);
	/**
