  ...
  $.widget('mp.marcoPolo', {
    ...
    options: {
      ...
      formatNoResults: function (q) {
        return '<em style="font-style: normal;">没有找到 <strong>' + q + '</strong>.</em>';
      },
    ...
    _buildResultsList: function (q, data) {
      ...
      for (var i = 0, length = data.length; i < length; i++) {
        datum = data[i];
        $item = $('<li class="mp_item layui-clear" />');
        ...
        var pHtml = '<p class="name">'+formatItem.lastName+'</p>';
            pHtml += '<p class="corporation">'+formatItem.fullName+'</p>';
            pHtml += '<p class="department">'+formatItem.deptFullname+'</p>';
        $item
          .html(pHtml)
          .appendTo($list);
