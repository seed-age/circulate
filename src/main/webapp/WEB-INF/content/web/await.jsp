...
<head>
    ...
    <![endif]-->
    <!-- ***************以上是公共部分************ -->
    <link rel="stylesheet" href="/resources/web/css/read.css?${date}">
    <script src="/resources/web/js/await.js?${date}"></script>
                ...
                <div class="read">
                    ...
                    <div class="oa-read-table layui-form">
                        ...
                        <table class="layui-table" lay-skin="nob" lay-filter="oa-read-table-data">
                            ...
                            <tfoot>
                            <tr>
                                <td colspan="6" style="text-align: right;" class="page-layout">
