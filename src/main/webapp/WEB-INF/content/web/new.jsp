...
<head>
	...
	<script src="/resources/web/js/jquery.ui.widget.min.js?${date}"></script>
	<script src="/resources/web/js/jquery.manifest.js?${date}"></script>
	<script src="/resources/web/js/jquery.marcopolo.min.js?${date}"></script>
	<!-- 附件上传 -->
